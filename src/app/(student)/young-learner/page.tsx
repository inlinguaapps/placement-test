// src\app\(student)\young-learner\page.tsx

import { getActiveBranches } from '@/app/actions'
import YoungLearnerFormClient from '@/app/(student)/young-learner/YoungLearnerFormClient'

export default async function YoungLearnerPage() {
  // Fetch branches on the server
  const branches = await getActiveBranches()

  return <YoungLearnerFormClient branches={branches} />
}
